    ...
    <main className="w-full h-[100vh] flex items-center justify-center">
      <section className="space-y-6">
        ...
        <div className="flex items-center justify-center">
          <Link to="/">
            <button className="bg-secondary text-white px-5 py-4 rounded-lg hover:bg-primary hover:transition-all hover:ease-linear hover:duration-300 text-base font-normal font-inter">
              Back To Home
            </button>
          </Link>
        </div>
